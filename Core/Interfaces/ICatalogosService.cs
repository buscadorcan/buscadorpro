...
namespace Core.Interfaces
{
    public interface ICatalogosService
    {
        ...
        /// </returns>
        List<VwGrillaDto> ObtenerVwGrilla();
        ...
        /// </returns>
        List<VwFiltroDto> ObtenerVwFiltro();
        ...
        /// Devuelve una lista de objetos VwFiltro con la estructura de los filtros configurados.
        /// </returns>
        Dictionary<string, List<vw_FiltrosAnidadosDto>> ObtenerFiltrosAnidados(List<FiltrosBusquedaSeleccionDto> filtrosSeleccionados);
        ...
        /// </returns>
        List<VwDimensionDto> ObtenerVwDimension();
        ...
        /// </returns>
        List<HomologacionDto> ObtenerGrupos();
        ...
        /// </returns>
        VwHomologacionGrupoDto? FindVwHGByCode(string codigoHomologacion);
        ...
        /// </returns>
        List<vwFiltroDetalleDto> ObtenerFiltroDetalles(string codigo);
        ...
        /// </returns>
        VwRolDto FindVwRolByHId(int idHomologacionRol);
        ...
        /// </returns>
        List<VwHomologacionGrupoDto> ObtenerVwHomologacionGrupo();
        ...
        /// </returns>
        List<vwPanelONADto> ObtenerVwPanelOna();
        ...
        /// </returns>
        List<vwEsquemaOrganizaDto> ObtenervwEsquemaOrganiza();
    }
}
